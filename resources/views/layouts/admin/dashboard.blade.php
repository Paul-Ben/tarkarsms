                    ...
                    <div class="flex justify-start items-center">
                        ...
                        <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                            <img src="https://flowbite.s3.amazonaws.com/logo.svg" class="mr-3 h-8"
                                alt="Flowbite Logo" />
                            <span
                                class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Tes'B Academy</span>
                        </a>
            ...
            <aside
                    ...
                    <ul class="space-y-2">
                            ...
                            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('student.index') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Student
                                        Info</a>
                                </li>
                                <li>
                                    <a href="{{route('search-class')}}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Class Student</a>
                                </li>
                                <li>
                                    <a href="#"
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap">Classroom Manager</span>
                                <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('classroom.index') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Class
                                        List</a>
                                </li>
                                <li>
                                    <a href="{{route('class-category.index')}}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Class Category</a>
                                </li>
                                <li>
                                    <a href="#"
                          ...
                          <ul id="dropdown-pages1" class="hidden py-2 space-y-2">
                              <li>
                                  <a href="{{ route('admin.manageuser') }}"
                                      class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage
                                      User</a>
                              </li>
                              <li>
                                  <a href="#"
                ...
                <div
                    ...
                    <button type="button" data-dropdown-toggle="language-dropdown"
                        ...
                        <svg aria-hidden="true" class="h-5 w-5 rounded-full mt-0.5"
